 ...
 * used to send admin to page with all rooms' classes.
 * 
 * 
...
public class ToAllClassesCommand implements ActionCommand {
	 ...
	 * method will get list with all rooms' classes and will send admin by
	...
	public Router execute(HttpServletRequest request) throws CommandException {
		...
		if (sessionData.getRole() == RoleType.ADMIN) {
			...
			try {
				List<RoomClass> roomClassList = AdminService.getClassesList(currentPage, recordsPerPage);
