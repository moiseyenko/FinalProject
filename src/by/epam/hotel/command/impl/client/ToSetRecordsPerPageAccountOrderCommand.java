...
public class ToSetRecordsPerPageAccountOrderCommand implements ActionCommand{
	...
	public Router execute(HttpServletRequest request) throws CommandException {
		System.out.println("in ToSetRecordsPerPageAccountOrderCommand " + request.getSession().getAttribute("sessionData"));
		...
		if (sessionData.getRole() == RoleType.CLIENT) {
			page = ConfigurationManager.getProperty("path.page.setrecordsperpageaccountorders");
		} else {
