 ...
 * and is used to send admin to page with all rooms' classes.
 * 
 * 
...
public class ToAllClassesCommand implements ActionCommand{
	 ...
	 * get list with all rooms' classes and will send admin  by {@link by.epam.hotel.util.type.RouterType FORWARD} 
