 ...
 * and is used to send admin to page with send message operation.
 * 
 * 
...
public class ToSubjectTextSendCommand implements ActionCommand{
	 ...
	 * admin  by {@link by.epam.hotel.util.type.RouterType FORWARD} to page with with send message operation.
