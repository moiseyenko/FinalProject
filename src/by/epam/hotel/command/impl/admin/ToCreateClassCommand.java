 ...
 * and is used to send admin to page with creation of rooms' class.
 * 
 * 
...
public class ToCreateClassCommand implements ActionCommand{
	 ...
	 * admin  by {@link by.epam.hotel.util.type.RouterType FORWARD} to page with creation of new rooms' class.
