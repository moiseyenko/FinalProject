 ...
 * and is used to send client to page with his orders.
 * 
 * 
...
public class ToAccountOrdersCommand implements ActionCommand {
	...
	/**
	 * If user's role equals to {@link by.epam.hotel.util.type.RoleType#CLIENT CLIENT}, method will
	 * get list with account orders and will send client  by {@link by.epam.hotel.util.type.RouterType FORWARD} 
