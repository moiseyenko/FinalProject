 ...
 * and is used to send admin to page with all nationalities.
 * 
 * 
...
public class ToAllNationalitiesCommand implements ActionCommand{
	 ...
	 * get list with all nationalities and will send admin  by {@link by.epam.hotel.util.type.RouterType FORWARD} 
