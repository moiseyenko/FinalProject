...
public class CreateRoomCommand implements ActionCommand {
	 ...
	 * page. If parameters: number, capacity and price are invalid or if new room
				...
				try {
					...
					try {
						if (AdminService.createRoom(newRoom)) {
							...
							request.setAttribute(AttributeConstant.ERROR_CREATE_ROOM_MESSAGE, MessageManager
									.getProrerty(PropertyConstant.MESSAGE_CREATE_ROOM_ERROR, sessionData.getLocale()));
