 ...
 * used to return client back to payment page.
 * 
 * 
...
public class BackToPayPageCommand implements ActionCommand {
	 ...
	 * method will return client back by {@link by.epam.hotel.util.type.RouterType#FORWARD
	 * FORWARD} to payment page. Otherwise method will return user by
